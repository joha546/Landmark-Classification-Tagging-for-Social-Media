...
def get_data_loaders(
    ...
    :return: a dictionary with keys 'train', 'valid', and 'test' containing
             the train, validation, and test data loaders respectively
    """
...
def test_data_loaders_output_type(data_loaders):
    ...
    try:
        ...
        assert False, "DataLoader iterator is empty, no data returned."
    ...
    assert images.shape[2] == 224 and images.shape[3] == 224, \
        f"The tensors returned by your dataloaders should be 224x224. " \
